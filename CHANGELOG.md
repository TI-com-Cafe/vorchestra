...
- Publish first binary artifacts through GitHub Releases.
- Add real screenshots/GIFs to the README.
- Validate packaged Linux, macOS, and Windows installers.
...
- Conda/Pixi support is inventory-first and read-only.
- Release workflow exists but still needs real tag validation.
- Screenshots/GIFs are not yet published in README.
